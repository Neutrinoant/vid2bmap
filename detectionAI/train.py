...
from dataset import SiameseNetworkDataset, SiameseNetworkColorDataset
...
def train_color():
    ...
    siamese_dataset = SiameseNetworkColorDataset(imageFolderDataset=folder_dataset,
                                            transform=transforms.Compose([transforms.Resize(Config.imgsize),
                                                                        transforms.ToTensor()
                                                                        ]),
                                            should_invert=False,
    ...
    net = SiameseNetworkColor(imgsize=Config.imgsize).to(Config.device)
    criterion = ContrastiveLoss()
    optimizer = optim.Adam(net.parameters(), lr=0.0005)
